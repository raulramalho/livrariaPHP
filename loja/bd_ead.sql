...
values(default,'Alexandre Aquiles'),		
(default, 'Tárcio Zemel'),					
(default, 'Rafael Steil'),					
(default, 'Fabricio Teixeira'),				
(default, 'Vinícius Carvalho'),				
(default, 'Fernando Baglio'),				
(default, 'David Paniz'),					
(default, 'Rosangela Marquesone'),		
(default, 'Natan Souza'),					
(default, 'Danilo Sato'),				   
(default, 'Juliano Ramos'),				  
(default, 'Fernando Bryan Frizzarin'),		
(default, 'Eduardo Popovici'),				
(default, 'Adrian Gois'),				    
(default, 'Everton Coimbra de Araújo'),		
(default, 'Sérgio Lopes'),				  
(default, 'Flávio Almeida'),			    
(default, 'Roger Silva');				   
